...
function mapDbMemberToAppMember(row) {
  ...
  return {
    ...
    activityWarningCode: normalizeText(activityState?.activityWarningCode),
    activityWarningUntilAt: normalizeText(activityState?.activityWarningUntilAt),
    activityWarningMessage: normalizeText(activityState?.activityWarningMessage),
